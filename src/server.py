...
async def weather(location: str = "上海") -> str:
    """
    获取指定位置的当前天气状况和空气质量，包含温度、体感、湿度、降水、风速、紫外线、AQI等信息。
    """
    import httpx
    import urllib.parse
    try:
